---
id: contract-a
title: Contract Answers
sidebar_label: Contract Answers
---
...
If you have made it this far then you 90% done with this tutorial. We have a minor few tweaks to another file then we can `cargo build`.
